      ...
      <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 max-w-5xl w-full flex flex-col md:flex-row items-center md:items-start gap-6">
        ...
        <div className="w-full md:w-1/2">
          ...
          <div className="mt-4 space-y-2 text-lg sm:text-xl text-center md:text-left">
            <p>
              <span className="font-semibold">🔋 Battery:</span> {ev.battery}{" "}
              kWh
            </p>
            <p>
              <span className="font-semibold">⚡ Range:</span> {ev.range} km
            </p>
            <p>
              <span className="font-semibold">🚀 Top Speed:</span> {ev.topSpeed}{" "}
              km/h
            </p>
            <p>
              <span className="font-semibold">💰 Price:</span> {ev.price}
            </p>
          </div>
